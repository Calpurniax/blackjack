...
1. Carta: es el un objeto con dos atributos: valor y palo.
1. Baraja: tiene 52 cartas, podemos crear la baraja siendo un array de las 52 cartas pero tenemos que conseguir que sean únicas. Inlcuye un método para mezclarlas.
